...
// checks if the MinusObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MinusObject{}
...
func (v NullableMinusObject) Get() *MinusObject {
	return v.value
}
...
func NewNullableMinusObject(val *MinusObject) *NullableMinusObject {
	return &NullableMinusObject{value: val, isSet: true}
}
