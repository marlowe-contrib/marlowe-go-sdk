...
// checks if the LabelRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LabelRef{}
...
func NewNullableLabelRef(val *LabelRef) *NullableLabelRef {
	return &NullableLabelRef{value: val, isSet: true}
}
