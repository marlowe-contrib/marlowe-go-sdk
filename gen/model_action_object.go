...
// ActionObjectOneOfAsActionObject is a convenience function that returns ActionObjectOneOf wrapped in ActionObject
func ActionObjectOneOfAsActionObject(v *ActionObjectOneOf) ActionObject {
	return ActionObject{
		ActionObjectOneOf: v,
	}
}
