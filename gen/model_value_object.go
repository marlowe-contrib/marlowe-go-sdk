...
// ActionObjectOneOfAsValueObject is a convenience function that returns ActionObjectOneOf wrapped in ValueObject
func ActionObjectOneOfAsValueObject(v *ActionObjectOneOf) ValueObject {
	return ValueObject{
		ActionObjectOneOf: v,
	}
}
