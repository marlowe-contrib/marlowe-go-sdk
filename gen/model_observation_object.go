...
// ValueObjectOneOf8AsObservationObject is a convenience function that returns ValueObjectOneOf8 wrapped in ObservationObject
func ValueObjectOneOf8AsObservationObject(v *ValueObjectOneOf8) ObservationObject {
	return ObservationObject{
		ValueObjectOneOf8: v,
	}
}
