...
type PostContractsRequest struct {
	...
	MinUTxODeposit int64 `json:"minUTxODeposit"`
...
// GetMinUTxODeposit returns the MinUTxODeposit field value
...
// GetMinUTxODepositOk returns a tuple with the MinUTxODeposit field value
// and a boolean to check if the value has been set.
...
// SetMinUTxODeposit sets field value
