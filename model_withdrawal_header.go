...
// checks if the WithdrawalHeader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WithdrawalHeader{}
...
type NullableWithdrawalHeader struct {
	value *WithdrawalHeader
	isSet bool
}

func (v NullableWithdrawalHeader) Get() *WithdrawalHeader {
	return v.value
}

func (v *NullableWithdrawalHeader) Set(val *WithdrawalHeader) {
	v.value = val
	v.isSet = true
}
...
func NewNullableWithdrawalHeader(val *WithdrawalHeader) *NullableWithdrawalHeader {
	return &NullableWithdrawalHeader{value: val, isSet: true}
}
